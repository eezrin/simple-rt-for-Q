...
var repo_site = "https://eezrin.github.io/simple-rt-for-Q/";
/* create timeline */
var timeline = [];
...
var instructions = {
  ...
  stimulus:
    ...
    repo_site +
    "img/blue.png'></img>" + // Change 2: Adding `repo_site` in `instructions`
    "<p class='small'><strong>Press the F key</strong></p></div>" +
    "<div class='float: right;'><img src='" +
    repo_site +
    "img/orange.png'></img>" + // Change 2: Adding `repo_site` in `instructions`
